...
37. Что делает функция Friend в C ++?
38. Что такое виртуальные функции?
39. В чем разница между мьютексом и семафором?
40. Как срабатывают конструкторы и деструкторы при наследовании в с++
41. Что такое string::npos?
42. Для чего нужен спецификатор final?
